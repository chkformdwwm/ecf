    ...
    <header class="d-flex justify-content-center">
        <div class="d-flex align-items-end">
            <div class="container position-absolute cover_text">
                <h1 class="display-1 fw-bold text-light cover_title">Savane</h1>
                <p class="lead mb-4 fw-medium text-light cover_paragraph">La savane est un écosystème complexe et dynamique, où les intercations entre le climat, la végétation et la faune créent un équilibre unique et vital pour la biodiversité de notre planète.</p>
            </div>
            <div>
                <img src="assets/img/cover_savane.jpg" class="cover_img w-100 h-100 img-fluid" alt="La locomotive du petit train du zoo et son conducteur qui agite la main par la fenêtre.">
            </div>
        </div>
    </header>
    <!--HEADER END-->
        ...
        <div class="container d-flex my-5 py-5">
            ...
            <div class="container d-flex justify-content-center align-items-center pt-5">
                <div class="mx-5 d-flex flex-column align-items-center">
                    <h2 class="text-center mb-4 fw-bold">Découvrez les aniaux de la savane</h2>
                            ...
                            foreach ($savaneAnimals as $savaneAnimal) { ?>
                                ...
                                <div class="col">
                                    <div class="mx-3 card shadow-sm">
                                        <div class="">
                                            <img src="./assets/img/<?= $savaneAnimal['photo_a'] ?>" class="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false">
                                        </div>
                                        <div class="card-body">
