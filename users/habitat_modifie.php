...
<body>
    <div class="d-flex justify-content-center">
        ...
        if (isset($_POST['updateHabitat'])) {
            $update = updateHabitat($pdo, $_POST['name'], $_POST['description'], $_POST['photos'], (int)$_POST['id']);
        }
        ...
        <div class="d-flex flex-column">
            ...
            <div>
                ...
                $habitat = getHabitatById($pdo, $id); { ?>
                    ...
                    <div>
                        <h2 class="text-center my-5 py-5">Modifier les informations de l'habitat</h2>

                        <div class="d-flex flex-column align-items-center">
                            <div class="w-25 my-5">
                                <img src="../../assets/img/<?= $habitat['photos'] ?>" class="rounded-circle img-thumbnail">
                            </div>

                            <h1 class="fw-bold text-center mb-5"><?= $habitat['name'] ?></h1>

                            <div class="container mb-5 pb-5">
                                <p class="text-center"><?php if (isset($_POST['updateHabitat'])) {
                                                            echo 'Les informations ont bien été enregistrées.';
                                                        } else  echo 'Les informations n\'ont pas été enregistrées.'; ?> <br>
                                <div class="mt-5 text-center"><a href="admin_habitats.php">Revenir à la liste des habitats.</div>
                                </p>
