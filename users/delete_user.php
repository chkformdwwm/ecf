...
<body>
    <header class="d-flex justify-content-center">
        ...
        if (isset($_POST['addUser'])) {
            $add = addUser($pdo, $_POST['name'], $_POST['firstname'], $_POST['email'], $_POST['password'], $_POST['staff_id']);
        } else
        ?>
        ...
        <div class="d-flex flex-column">
            ...
            var_dump($user);
                ...
                <div>
                    <h2 class="text-center my-5 py-5">Supprimer un utilisateur</h2>
                    ...
                    <div class=" container mb-5 pb-5">
                        ...
                        <div class="container mb-5 pb-5">
                            <p><?php if (isset($_POST['addUser'])) {
                                ?>
                            <p class="text-center alert alert-success" role="alert"> <?= 'L\'utilisateur a bien été enregistré.'; ?></p>
                        <?php  }  ?> <br>
                        ...
                        <?php if (!isset($_POST['addUser'])) { ?>
                            ...
                            <form action="" method="post">
                                ...
                                <div>
                                    ...
                                    <input id="staff_id" type="text" name="staff_id" class="form-control" required />
                                </div><br />


                                <div class="d-flex">
                                    <input type="submit" value="Valider" name="addUser" formaction="" class="btn btn-primary mx-2">
                                </div>
                            </form>
