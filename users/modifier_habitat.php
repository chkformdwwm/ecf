...
<body>
    <header class="d-flex justify-content-center">
        ...
        if (isset($_POST['updateHabitat'])) {
            $update = updateHabitat($pdo, $_POST['name'], $_POST['description'], $_POST['photos'], (int)$_GET['id']);
        }
                ...
                <div class="row py-lg-5">
                    <div class="col-lg-10 col-md-8 mx-auto">
                        <div class="d-flex flex-column align-items-center">
                            <div class="w-25 mb-5">
                                <img src="../../assets/img/<?= $habitats['photos'] ?>" class="rounded-circle img-thumbnail">
                            </div>
                        </div>
                        <div>
                            <h1 class="fw-light text-center">Modification des données de l'habitat «<?= $habitats['name'] ?>»</h1>
                            <p class="lead text-body-secondary text-center">Ajouter vos modifications pour cet habitat</p>
                            <p>
                        </div>
                        ...
                        <form action="" method="post">
                            ...
                            <div>
                                ...
                                <input id="name" type="text" name="name" value="<?= $habitats['name'] ?>" class="form-control" required />
                            </div><br />


                            <div>
                                <label for="description" class="form-label">Description</label>
                                <textarea id="description" name="description" rows="4" cols="50" class="form-control" required> <?= $habitats['description'] ?></textarea>
                            </div><br />


                            <div>
                                <label for="photos" class="form-label">Photo</label>
                                <input id="photos" type="text" name="photos" class="form-control" value="<?= $habitats['photos'] ?>" required />
                            </div><br />

                            <div class="d-flex">
                                <input id="id" name="id" type="hidden" value="<?= $habitats['id'] ?>" />
                                <input type="submit" value="Valider les modifications" formaction="habitat_modifie.php" name="updateHabitat" class="btn btn-primary mx-2">
