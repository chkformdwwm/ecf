                ...
                <section class="py-5 container">
                    <div class="row py-lg-5">
                        <div class="col-lg-6 col-md-8 mx-auto">
                            ...
                            <p class="lead text-body-secondary text-center">Les trois habitats du zoo</p>
                            <div class="d-flex justify-content-center ">
                                <a href="admin_habitats.php" class="btn btn-primary my-2">Modifier les habitats</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                            ...
                            foreach ($habitats as $habitat) { ?>
                                <div class="col ">
                                    <div class="col mx-3 card h-100 shadow-sm">
                                        <div class="">
                                        ...
                                        <div class="card-body row">
                                            ...
                                            <div class="d-flex align-items-end">
                                                ...
                                                <a href="<?= $habitat['admin_url'] ?>" class="btn btn-primary my-2">Voir la page</a>
                ...
                <section class="py-5  container">
                    <div class="row py-lg-5">
                        <div class="col-lg-6 col-md-8 mx-auto">
                            ...
                            <div class="d-flex justify-content-center ">
                                <a href="admin_services.php" class="btn btn-primary my-2">Modifier les services</a>
                            </div>
                        </div>
                    </div>
