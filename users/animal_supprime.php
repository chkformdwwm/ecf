        ...
        <div class="d-flex flex-column">
            ...
            <div>
                ...
                var_dump($animal); { ?>
                    ...
                    <div>
                        <h2 class="text-center my-5 py-5">Supprimer la fiche d'un animal</h2>
                        ...
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <div class="container mb-5 pb-5">
                                <p class="text-center"><?php if (isset($_POST['deleteAnimal'])) {
                                                            echo 'La fiche de cet animal a bien été supprimée.';
                                                        } else  echo 'Erreur lors de la suppression de la fiche animal.'; ?> <br>
