    ...
    <div class="d-flex justify-content-center">
        ...
        <main>
            <div class="d-flex flex-column">
                ...
                <div>
                    <?php $id = (int)$_GET['id'];
                    $animal = getAnimalMeal($pdo, $id); { ?>

                        <div>
                            <div class="container-fluid ">
                                <h2 class="text-center my-5 py-5">Consulter l'historique des repas de l'animal</h2>
                                <p class=""><span class="fw-bold">Date : </span><span><?= $animal['date'] ?></span></p>
                                <p class=""><span class="fw-bold">Heure : </span><span><?= $animal['heure'] ?></span></p>
                                <p class=""><span class="fw-bold">Nourriture : </span><span><?= $animal['nourriture'] ?></span></p>
                                <p class=""><span class="fw-bold">Quantité : </span><span><?= $animal['quantite'] ?></span></p>
                            </div>
