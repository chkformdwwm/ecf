...
<body>
    ...
    <div class="d-flex flex-column container-fluid">
        ...
        <div>
            <h2 class="text-center my-5 py-5">Liste des utilisateurs</h2>
            <p class="text-center"><a href="register.php">Ajouter un utilisateur</a>
        </div>
        ...
        <div class="container-fluid mx-5">
            ...
            foreach ($users as $user) { ?>
                ...
                <div class="mx-5 mb-4 border-bottom">
                    <div class="mx-5">
                        <p><span class="fw-bold">Nom : </span><span><?= $user['name'] ?></span></p>
                        <p><span class="fw-bold">Prénom : </span><span><?= $user['firstname'] ?></span></p>
                        <p><span class="fw-bold">Adresse e-mail : </span><span><?= $user['email'] ?></span></p>
                        <p><span class="fw-bold">Statut : </span><span><?= $user['staff_category'] ?></span></p>
                    ...
                    <div class="d-flex mx-5 mb-4">
                        <form action="" method="post">
                            ...
                            <input type="submit" value="Modifier" name="updateUser" formaction="modify_user.php" class="btn btn-primary mx-2">
                        </form>
                        <form action="" method="post">
                            <input type="submit" value="Supprimer" name="deleteUser" formaction="delete_user.php" class="btn btn-primary mx-2">
                        </form>
                    </div>
                </div>
