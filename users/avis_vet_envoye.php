...
<body>
    <div class="d-flex justify-content-center">
        ...
        if (isset($_POST['avisVeterinaire'])) {
            $add = newVetVisit($pdo, $_POST['etat_animal'], $_POST['nourriture'], $_POST['ration'], $_POST['passage'], $_POST['details_etat'], $_POST['id']);
        } else
                    ...
                    <div>
                        ...
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <div class="container mb-5 pb-5">
                                <p class="text-center"><?php if (isset($_POST['avisVeterinaire'])) {
                                                            echo 'Les informations ont bien été enregistrées.';
                                                        } else  echo 'Les informations n\'ont pas été enregistrées.'; ?> <br>
                                <div class="mt-5 text-center"><a href="accueil_veterinaire.php">Revenir à l'accueil de votre espace.</div>
                                </p>
